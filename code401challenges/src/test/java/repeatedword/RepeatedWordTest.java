...
public class RepeatedWordTest {
    ...
    @Test public void repeatedWord()
    {
        ...
        String expected = "it";
        assertEquals(expected, RepeatedWord.repeatedWord(paragraph));
    }

    @Test
    public void repeatedWordTwo()
    {
    ...
    @Test
    public void repeatedWordThree()
    {
        String paragraph = "Find the first repeated word in a word book";
